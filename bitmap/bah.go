...
// BAH07 compression is a minor variation on WAH bitmap compression, the difference being:
//
...
//  - BAH07 has a 7bit run length multiples of 7 0s (max 127x7=889 consecutive 0s)
//
...
// REVU bitmap is a BAH-0 .. tag space of a doc is very sparse so no 1 fill blocks
